...
public class AdminController {
    ...
    public AdminController(ShopService shopService, TagService tagService,
                           ...
                           ReviewService reviewService, PaginationService paginationService, ThemeService themeService, ShopTownService shopTownService, RegionService regionService, TagListService tagListService, MemberService memberService, CategoryService categoryService) {
...
//        this.regionService = regionService;
        ...
        this.shopTownService = shopTownService;
